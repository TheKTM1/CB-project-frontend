        ...
        <div class="container-fluid">
            ...
            <div v-if="!auth">
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    <li class="nav-item">
                        <router-link to="/register" class="nav-link active" aria-current="page" href="#">Rejestracja</router-link>
                    </li>
                    <li class="nav-item">
                        <router-link to="/login" class="nav-link active" aria-current="page" href="#">Logowanie</router-link>
                    </li>
                </ul>
            </div>
            <div v-if="auth">
